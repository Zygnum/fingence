...
/**
 * Provides the remote service interface for PortfolioItem. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Ahmed Hasan
 * @see PortfolioItemServiceUtil
...
public interface PortfolioItemService extends BaseService, InvokableService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PortfolioItemServiceUtil} to access the portfolio item remote service. Add custom service methods to {@link com.fingence.slayer.service.impl.PortfolioItemServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

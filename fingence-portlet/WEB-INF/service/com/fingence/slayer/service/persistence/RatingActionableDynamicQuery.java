 ...
 * @generated
 */
public abstract class RatingActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public RatingActionableDynamicQuery() throws SystemException {
		setBaseLocalService(RatingLocalServiceUtil.getService());
		setClass(Rating.class);

		setClassLoader(com.fingence.slayer.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("ratingId");
	}
}
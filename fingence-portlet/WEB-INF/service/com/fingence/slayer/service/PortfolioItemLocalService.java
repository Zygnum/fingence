...
/**
 * Provides the local service interface for PortfolioItem. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ahmed Hasan
 * @see PortfolioItemLocalServiceUtil
...
public interface PortfolioItemLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PortfolioItemLocalServiceUtil} to access the portfolio item local service. Add custom service methods to {@link com.fingence.slayer.service.impl.PortfolioItemLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

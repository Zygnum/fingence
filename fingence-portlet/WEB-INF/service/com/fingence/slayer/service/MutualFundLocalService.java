...
/**
 * Provides the local service interface for MutualFund. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ahmed Hasan
 * @see MutualFundLocalServiceUtil
...
public interface MutualFundLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MutualFundLocalServiceUtil} to access the mutual fund local service. Add custom service methods to {@link com.fingence.slayer.service.impl.MutualFundLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

...
/**
 * Provides the local service interface for Dividend. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ahmed Hasan
 * @see DividendLocalServiceUtil
...
public interface DividendLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DividendLocalServiceUtil} to access the dividend local service. Add custom service methods to {@link com.fingence.slayer.service.impl.DividendLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

...
/**
 * Provides the remote service interface for ReportConfig. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Ahmed Hasan
 * @see ReportConfigServiceUtil
...
public interface ReportConfigService extends BaseService, InvokableService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ReportConfigServiceUtil} to access the report config remote service. Add custom service methods to {@link com.fingence.slayer.service.impl.ReportConfigServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

...
public class AssetLocalServiceWrapper implements AssetLocalService,
	...
	*/
	...
	public void loadPricingData(long userId, java.io.File excelFile,
		...
		_assetLocalService.loadPricingData(userId, excelFile, serviceContext,
			type);
	}
	...
	public void loadDividends(long userId, java.io.File excelFile,
		...
		_assetLocalService.loadDividends(userId, excelFile, serviceContext);
	}

	@Override
	public void importFromExcel(long userId, java.io.File excelFile,
		com.liferay.portal.service.ServiceContext serviceContext) {
		_assetLocalService.importFromExcel(userId, excelFile, serviceContext);
	}

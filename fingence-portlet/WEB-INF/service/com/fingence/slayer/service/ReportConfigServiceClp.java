 ...
 * @generated
 */
public class ReportConfigServiceClp implements ReportConfigService {
	public ReportConfigServiceClp(InvokableService invokableService) {
		...
		_methodName3 = "getTreeStructure";

		_methodParameterTypes3 = new String[] { "java.lang.String" };

		_methodName4 = "getReportConfig";

		_methodParameterTypes4 = new String[] { "long" };

		_methodName5 = "setReportConfig";

		_methodParameterTypes5 = new String[] { "long", "boolean" };

		_methodName6 = "getMenuItems";
	...
	public com.fingence.slayer.model.ReportConfig getReportConfig(long reportId) {
		...
		try {
			returnObj = _invokableService.invokeMethod(_methodName4,
					_methodParameterTypes4, new Object[] { reportId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public com.fingence.slayer.model.ReportConfig setReportConfig(
		...
		try {
			returnObj = _invokableService.invokeMethod(_methodName5,
					_methodParameterTypes5, new Object[] { reportId, enabled });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.Map<java.lang.Long, java.lang.String> getMenuItems(
		...
		try {
			returnObj = _invokableService.invokeMethod(_methodName6,
					_methodParameterTypes6, new Object[] { parentCategoryId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);

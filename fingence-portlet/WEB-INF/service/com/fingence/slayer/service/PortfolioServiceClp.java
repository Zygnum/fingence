...
public class PortfolioServiceClp implements PortfolioService {
	public PortfolioServiceClp(InvokableService invokableService) {
		...
		_methodName3 = "makePrimary";

		_methodParameterTypes3 = new String[] { "long" };

		_methodName4 = "getPortfolios";

		_methodParameterTypes4 = new String[] { "long" };

		_methodName5 = "getDefault";

		_methodParameterTypes5 = new String[] { "long" };

		_methodName6 = "getPortoliosCount";

		_methodParameterTypes6 = new String[] { "long" };

		_methodName7 = "getPortfolio";

		_methodParameterTypes7 = new String[] { "long" };

		_methodName8 = "getPortfolioName";

		_methodParameterTypes8 = new String[] { "long" };

		_methodName9 = "getPortfolioSummary";

		_methodParameterTypes9 = new String[] { "long" };

		_methodName10 = "deletePortfolio";

		_methodParameterTypes10 = new String[] { "long" };

		_methodName11 = "getBaseCurrency";

		_methodParameterTypes11 = new String[] { "long" };

		_methodName12 = "getSnapshot";

		_methodParameterTypes12 = new String[] { "java.lang.String", "int" };
	}
	...
	public com.fingence.slayer.model.Portfolio getPortfolio(long portfolioId) {
		...
		try {
			returnObj = _invokableService.invokeMethod(_methodName7,
					_methodParameterTypes7, new Object[] { portfolioId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.lang.String getPortfolioName(long portfolioId) {
		...
		try {
			returnObj = _invokableService.invokeMethod(_methodName8,
					_methodParameterTypes8, new Object[] { portfolioId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public com.liferay.portal.kernel.json.JSONArray getSnapshot(
		...
		try {
			returnObj = _invokableService.invokeMethod(_methodName12,
					...
					new Object[] {
						ClpSerializer.translateInput(portfolioIds),

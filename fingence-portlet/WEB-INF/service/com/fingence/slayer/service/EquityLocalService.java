...
/**
 * Provides the local service interface for Equity. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ahmed Hasan
 * @see EquityLocalServiceUtil
...
public interface EquityLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EquityLocalServiceUtil} to access the equity local service. Add custom service methods to {@link com.fingence.slayer.service.impl.EquityLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

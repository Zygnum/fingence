...
/**
 * Provides the local service interface for Bond. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ahmed Hasan
 * @see BondLocalServiceUtil
...
public interface BondLocalService extends BaseLocalService, InvokableLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link BondLocalServiceUtil} to access the bond local service. Add custom service methods to {@link com.fingence.slayer.service.impl.BondLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

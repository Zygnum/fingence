...
import com.fingence.slayer.service.MyResultLocalService;
...
/**
 * Provides the base implementation for the my result local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fingence.slayer.service.impl.MyResultLocalServiceImpl}.
 * </p>
 *
 * @author Ahmed Hasan
 ...
 * @generated
 */
public abstract class MyResultLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements MyResultLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fingence.slayer.service.MyResultLocalServiceUtil} to access the my result local service.
	 */
	...
	@Override
	public MyResult addMyResult(MyResult myResult) throws SystemException {
		myResult.setNew(true);

		return myResultPersistence.update(myResult);
	}
	 ...
	 */
	@Override
	public MyResult createMyResult(long itemId) {
		return myResultPersistence.create(itemId);
	}
	...
	@Override
	public MyResult deleteMyResult(long itemId)
		throws PortalException, SystemException {
		return myResultPersistence.remove(itemId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public MyResult deleteMyResult(MyResult myResult) throws SystemException {
		return myResultPersistence.remove(myResult);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(MyResult.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return myResultPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return myResultPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return myResultPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return myResultPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public MyResult fetchMyResult(long itemId) throws SystemException {
		return myResultPersistence.fetchByPrimaryKey(itemId);
	}
	 ...
	 */
	@Override
	public MyResult getMyResult(long itemId)
		throws PortalException, SystemException {
		return myResultPersistence.findByPrimaryKey(itemId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return myResultPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<MyResult> getMyResults(int start, int end)
		throws SystemException {
		return myResultPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getMyResultsCount() throws SystemException {
		return myResultPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public MyResult updateMyResult(MyResult myResult) throws SystemException {
		return myResultPersistence.update(myResult);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.fingence.slayer.model.MyResult",
			myResultLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = myResultPersistence.getDataSource();
	...
	private MyResultLocalServiceClpInvoker _clpInvoker = new MyResultLocalServiceClpInvoker();
}
...
public class AssetLocalServiceClpInvoker {
	public AssetLocalServiceClpInvoker() {
		...
		_methodName112 = "loadPricingData";
		...
		_methodName114 = "importFromExcel";
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName0.equals(name) &&
			...
			return AssetLocalServiceUtil.addAsset((com.fingence.slayer.model.Asset)arguments[0]);
		}
		...
		if (_methodName3.equals(name) &&
			...
			return AssetLocalServiceUtil.deleteAsset((com.fingence.slayer.model.Asset)arguments[0]);
		}
		...
		if (_methodName15.equals(name) &&
			...
			return AssetLocalServiceUtil.updateAsset((com.fingence.slayer.model.Asset)arguments[0]);
		}
		...
		if (_methodName112.equals(name) &&
			...
			AssetLocalServiceUtil.loadPricingData(((Long)arguments[0]).longValue(),
		...
		if (_methodName113.equals(name) &&
			...
			AssetLocalServiceUtil.loadDividends(((Long)arguments[0]).longValue(),
				(java.io.File)arguments[1],
				(com.liferay.portal.service.ServiceContext)arguments[2]);
		...
		if (_methodName114.equals(name) &&
			...
			AssetLocalServiceUtil.importFromExcel(((Long)arguments[0]).longValue(),
				(java.io.File)arguments[1],
				(com.liferay.portal.service.ServiceContext)arguments[2]);

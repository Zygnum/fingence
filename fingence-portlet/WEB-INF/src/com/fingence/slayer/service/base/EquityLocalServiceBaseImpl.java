...
import com.fingence.slayer.service.EquityLocalService;
...
/**
 * Provides the base implementation for the equity local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fingence.slayer.service.impl.EquityLocalServiceImpl}.
 * </p>
 *
 * @author Ahmed Hasan
 ...
 * @generated
 */
public abstract class EquityLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements EquityLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fingence.slayer.service.EquityLocalServiceUtil} to access the equity local service.
	 */
	...
	@Override
	public Equity addEquity(Equity equity) throws SystemException {
		equity.setNew(true);

		return equityPersistence.update(equity);
	}
	 ...
	 */
	@Override
	public Equity createEquity(long assetId) {
		return equityPersistence.create(assetId);
	}
	...
	@Override
	public Equity deleteEquity(long assetId)
		throws PortalException, SystemException {
		return equityPersistence.remove(assetId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Equity deleteEquity(Equity equity) throws SystemException {
		return equityPersistence.remove(equity);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Equity.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return equityPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return equityPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return equityPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return equityPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public Equity fetchEquity(long assetId) throws SystemException {
		return equityPersistence.fetchByPrimaryKey(assetId);
	}
	 ...
	 */
	@Override
	public Equity getEquity(long assetId)
		throws PortalException, SystemException {
		return equityPersistence.findByPrimaryKey(assetId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return equityPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Equity> getEquities(int start, int end)
		throws SystemException {
		return equityPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getEquitiesCount() throws SystemException {
		return equityPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Equity updateEquity(Equity equity) throws SystemException {
		return equityPersistence.update(equity);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.fingence.slayer.model.Equity",
			equityLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = equityPersistence.getDataSource();
	...
	private EquityLocalServiceClpInvoker _clpInvoker = new EquityLocalServiceClpInvoker();
}
...
public class HistoryLocalServiceClpInvoker {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName0.equals(name) &&
			...
			return HistoryLocalServiceUtil.addHistory((com.fingence.slayer.model.History)arguments[0]);
		}
		...
		if (_methodName3.equals(name) &&
			...
			return HistoryLocalServiceUtil.deleteHistory((com.fingence.slayer.model.History)arguments[0]);
		}
		...
		if (_methodName15.equals(name) &&
			...
			return HistoryLocalServiceUtil.updateHistory((com.fingence.slayer.model.History)arguments[0]);
		}

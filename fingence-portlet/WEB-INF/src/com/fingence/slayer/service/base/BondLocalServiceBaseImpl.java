...
import com.fingence.slayer.service.BondLocalService;
...
/**
 * Provides the base implementation for the bond local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fingence.slayer.service.impl.BondLocalServiceImpl}.
 * </p>
 *
 * @author Ahmed Hasan
 ...
 * @generated
 */
public abstract class BondLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements BondLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fingence.slayer.service.BondLocalServiceUtil} to access the bond local service.
	 */
	...
	@Override
	public Bond addBond(Bond bond) throws SystemException {
		bond.setNew(true);

		return bondPersistence.update(bond);
	}
	 ...
	 */
	@Override
	public Bond createBond(long assetId) {
		return bondPersistence.create(assetId);
	}
	...
	@Override
	public Bond deleteBond(long assetId)
		throws PortalException, SystemException {
		return bondPersistence.remove(assetId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Bond deleteBond(Bond bond) throws SystemException {
		return bondPersistence.remove(bond);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Bond.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return bondPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return bondPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return bondPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return bondPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public Bond fetchBond(long assetId) throws SystemException {
		return bondPersistence.fetchByPrimaryKey(assetId);
	}
	 ...
	 */
	@Override
	public Bond getBond(long assetId) throws PortalException, SystemException {
		return bondPersistence.findByPrimaryKey(assetId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return bondPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Bond> getBonds(int start, int end) throws SystemException {
		return bondPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getBondsCount() throws SystemException {
		return bondPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Bond updateBond(Bond bond) throws SystemException {
		return bondPersistence.update(bond);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.fingence.slayer.model.Bond",
			bondLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.fingence.slayer.model.Bond");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = bondPersistence.getDataSource();
	...
	private BondLocalServiceClpInvoker _clpInvoker = new BondLocalServiceClpInvoker();
}